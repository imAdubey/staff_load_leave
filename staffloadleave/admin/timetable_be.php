<?php 
  ...
  $db = mysqli_connect("localhost", "root", "", "sllm");
    ...
    if(isset($_POST['save1'])){
      ...
      $q = "SELECT * FROM lectures_be WHERE id = '$id' ";
      $q_exe = mysqli_query($db, $q);
      $count = mysqli_num_rows($q_exe);

      if($count == 0){
        $q1 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id', '$subject', '$lecturer', '$day', '$time')";
        ...
        $q2 = " UPDATE lectures_be SET subjects ='$subject', prof_name = '$lecturer' WHERE id = '$id' ";
    ...
    if(isset($_POST['save2'])){
      ...
      $q3 = "SELECT * FROM lectures_be WHERE id = '$id1' ";
      $q3_exe = mysqli_query($db, $q3);
      $count1 = mysqli_num_rows($q3_exe);

      if($count1 == 0){
        $q4 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id1', '$subject1', '$lecturer1', '$day1', '$time1')";
        ...
        $q5 = " UPDATE lectures_be SET subjects ='$subject1', prof_name = '$lecturer1' WHERE id = '$id1' ";
    ...
    if(isset($_POST['save3'])){
      ...
      $q6 = "SELECT * FROM lectures_be WHERE id = '$id2' ";
      $q6_exe = mysqli_query($db, $q6);
      $count2 = mysqli_num_rows($q6_exe);

      if($count2 == 0){
        $q7 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id2', '$subject2', '$lecturer2', '$day2', '$time2')";
        ...
        $q8 = " UPDATE lectures_be SET subjects ='$subject2', prof_name = '$lecturer2' WHERE id = '$id2' ";
    ...
    if(isset($_POST['save4'])){
      ...
      $q9 = "SELECT * FROM lectures_be WHERE id = '$id3' ";
      $q9_exe = mysqli_query($db, $q9);
      $count3 = mysqli_num_rows($q9_exe);

      if($count3 == 0){
        $q10 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id3', '$subject3', '$lecturer3', '$day3', '$time3')";
        ...
        $q11 = " UPDATE lectures_be SET subjects ='$subject3', prof_name = '$lecturer3' WHERE id = '$id3' ";
    ...
    if(isset($_POST['save5'])){
      ...
      $q12 = "SELECT * FROM lectures_be WHERE id = '$id4' ";
      $q12_exe = mysqli_query($db, $q12);
      $count4 = mysqli_num_rows($q12_exe);

      if($count4 == 0){
        $q13 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id4', '$subject4', '$lecturer4', '$day4', '$time4')";
        ...
        $q14 = " UPDATE lectures_be SET subjects ='$subject4', prof_name = '$lecturer4' WHERE id = '$id4' ";
    ...
    if(isset($_POST['save6'])){
      ...
      $q15 = "SELECT * FROM lectures_be WHERE id = '$id5' ";
      $q15_exe = mysqli_query($db, $q15);
      $count5 = mysqli_num_rows($q15_exe);

      if($count5 == 0){
        $q16 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id5', '$subject5', '$lecturer5', '$day5', '$time5')";
        ...
        $q17 = " UPDATE lectures_be SET subjects ='$subject5', prof_name = '$lecturer5' WHERE id = '$id5' ";
    ...
    if(isset($_POST['save7'])){
      ...
      $q18 = "SELECT * FROM lectures_be WHERE id = '$id6' ";
      $q18_exe = mysqli_query($db, $q18);
      $count6 = mysqli_num_rows($q18_exe);

      if($count6 == 0){
        $q19 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id6', '$subject6', '$lecturer6', '$day6', '$time6')";
        ...
        $q20 = " UPDATE lectures_be SET subjects ='$subject6', prof_name = '$lecturer6' WHERE id = '$id6' ";
    ...
    if(isset($_POST['save8'])){
      ...
      $q21 = "SELECT * FROM lectures_be WHERE id = '$id7' ";
      $q21_exe = mysqli_query($db, $q21);
      $count7 = mysqli_num_rows($q21_exe);

      if($count7 == 0){
        $q22 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id7', '$subject7', '$lecturer7', '$day7', '$time7')";
        ...
        $q23 = " UPDATE lectures_be SET subjects ='$subject7', prof_name = '$lecturer7' WHERE id = '$id7' ";
    ...
    if(isset($_POST['save9'])){
      ...
      $q24 = "SELECT * FROM lectures_be WHERE id = '$id8' ";
      $q24_exe = mysqli_query($db, $q24);
      $count8 = mysqli_num_rows($q24_exe);

      if($count8 == 0){
        $q25 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id8', '$subject8', '$lecturer8', '$day8', '$time8')";
        ...
        $q26 = " UPDATE lectures_be SET subjects ='$subject8', prof_name = '$lecturer8' WHERE id = '$id8' ";
    ...
    if(isset($_POST['save10'])){
      ...
      $q27 = "SELECT * FROM lectures_be WHERE id = '$id9' ";
      $q27_exe = mysqli_query($db, $q27);
      $count9 = mysqli_num_rows($q27_exe);

      if($count9 == 0){
        $q28 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id9', '$subject9', '$lecturer9', '$day9', '$time9')";
        ...
        $q29 = " UPDATE lectures_be SET subjects ='$subject9', prof_name = '$lecturer9' WHERE id = '$id9' ";
    ...
    if(isset($_POST['save11'])){
      ...
      $q30 = "SELECT * FROM lectures_be WHERE id = '$id10' ";
      $q30_exe = mysqli_query($db, $q30);
      $count10 = mysqli_num_rows($q30_exe);

      if($count10 == 0){
        $q31 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id10', '$subject10', '$lecturer10', '$day10', '$time10')";
        ...
        $q32 = " UPDATE lectures_be SET subjects ='$subject10', prof_name = '$lecturer10' WHERE id = '$id10' ";
    ...
    if(isset($_POST['save12'])){
      ...
      $q33 = "SELECT * FROM lectures_be WHERE id = '$id11' ";
      $q33_exe = mysqli_query($db, $q33);
      $count11 = mysqli_num_rows($q33_exe);

      if($count11 == 0){
        $q34 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id11', '$subject11', '$lecturer11', '$day11', '$time11')";
        ...
        $q35 = " UPDATE lectures_be SET subjects ='$subject11', prof_name = '$lecturer11' WHERE id = '$id11' ";
    ...
    if(isset($_POST['save13'])){
      ...
      $q36 = "SELECT * FROM lectures_be WHERE id = '$id12' ";
      $q36_exe = mysqli_query($db, $q36);
      $count12 = mysqli_num_rows($q36_exe);

      if($count12 == 0){
        $q37 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id12', '$subject12', '$lecturer12', '$day12', '$time12')";
        ...
        $q38 = " UPDATE lectures_be SET subjects ='$subject12', prof_name = '$lecturer12' WHERE id = '$id12' ";
    ...
    if(isset($_POST['save14'])){
      ...
      $q39 = "SELECT * FROM lectures_be WHERE id = '$id13' ";
      $q39_exe = mysqli_query($db, $q39);
      $count13 = mysqli_num_rows($q39_exe);

      if($count13 == 0){
        $q40 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id13', '$subject13', '$lecturer13', '$day13', '$time13')";
        ...
        $q41 = " UPDATE lectures_be SET subjects ='$subject13', prof_name = '$lecturer13' WHERE id = '$id13' ";
    ...
    if(isset($_POST['save15'])){
      ...
      $q42 = "SELECT * FROM lectures_be WHERE id = '$id14' ";
      $q42_exe = mysqli_query($db, $q42);
      $count14 = mysqli_num_rows($q42_exe);

      if($count14 == 0){
        $q43 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id14', '$subject14', '$lecturer14', '$day14', '$time14')";
        ...
        $q44 = " UPDATE lectures_be SET subjects ='$subject14', prof_name = '$lecturer14' WHERE id = '$id14' ";
    ...
    if(isset($_POST['save16'])){
      ...
      $q45 = "SELECT * FROM lectures_be WHERE id = '$id15' ";
      $q45_exe = mysqli_query($db, $q45);
      $count15 = mysqli_num_rows($q45_exe);

      if($count15 == 0){
        $q46 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id15', '$subject15', '$lecturer15', '$day15', '$time15')";
        ...
        $q47 = " UPDATE lectures_be SET subjects ='$subject15', prof_name = '$lecturer15' WHERE id = '$id15' ";
    ...
    if(isset($_POST['save17'])){
      ...
      $q48 = "SELECT * FROM lectures_be WHERE id = '$id16' ";
      $q48_exe = mysqli_query($db, $q48);
      $count16 = mysqli_num_rows($q48_exe);

      if($count16 == 0){
        $q49 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id16', '$subject16', '$lecturer16', '$day16', '$time16')";
        ...
        $q50 = " UPDATE lectures_be SET subjects ='$subject16', prof_name = '$lecturer16' WHERE id = '$id16' ";
    ...
    if(isset($_POST['save18'])){
      ...
      $q51 = "SELECT * FROM lectures_be WHERE id = '$id17' ";
      $q51_exe = mysqli_query($db, $q51);
      $count17 = mysqli_num_rows($q51_exe);

      if($count17 == 0){
        $q52 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id17', '$subject17', '$lecturer17', '$day17', '$time17')";
        ...
        $q53 = " UPDATE lectures_be SET subjects ='$subject17', prof_name = '$lecturer17' WHERE id = '$id17' ";
    ...
    if(isset($_POST['save19'])){
      ...
      $q54 = "SELECT * FROM lectures_be WHERE id = '$id18' ";
      $q54_exe = mysqli_query($db, $q54);
      $count18 = mysqli_num_rows($q54_exe);

      if($count18 == 0){
        $q55 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id18', '$subject18', '$lecturer18', '$day18', '$time18')";
        ...
        $q56 = " UPDATE lectures_be SET subjects ='$subject18', prof_name = '$lecturer18' WHERE id = '$id18' ";
    ...
    if(isset($_POST['save20'])){
      ...
      $q57 = "SELECT * FROM lectures_be WHERE id = '$id19' ";
      $q57_exe = mysqli_query($db, $q57);
      $count19 = mysqli_num_rows($q57_exe);

      if($count19 == 0){
        $q58 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id19', '$subject19', '$lecturer19', '$day19', '$time19')";
        ...
        $q59 = " UPDATE lectures_be SET subjects ='$subject19', prof_name = '$lecturer19' WHERE id = '$id19' ";
    ...
    if(isset($_POST['save21'])){
      ...
      $q60 = "SELECT * FROM lectures_be WHERE id = '$id20' ";
      $q60_exe = mysqli_query($db, $q60);
      $count20 = mysqli_num_rows($q60_exe);

      if($count20 == 0){
        $q61 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id20', '$subject20', '$lecturer20', '$day20', '$time20')";
        ...
        $q62 = " UPDATE lectures_be SET subjects ='$subject20', prof_name = '$lecturer20' WHERE id = '$id20' ";
    ...
    if(isset($_POST['save22'])){
      ...
      $q63 = "SELECT * FROM lectures_be WHERE id = '$id21' ";
      $q63_exe = mysqli_query($db, $q63);
      $count21 = mysqli_num_rows($q63_exe);

      if($count21 == 0){
        $q64 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id21', '$subject21', '$lecturer21', '$day21', '$time21')";
        ...
        $q65 = " UPDATE lectures_be SET subjects ='$subject21', prof_name = '$lecturer21' WHERE id = '$id21' ";
    ...
    if(isset($_POST['save23'])){
      ...
      $q66 = "SELECT * FROM lectures_be WHERE id = '$id22' ";
      $q66_exe = mysqli_query($db, $q66);
      $count22 = mysqli_num_rows($q66_exe);

      if($count22 == 0){
        $q67 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id22', '$subject22', '$lecturer22', '$day22', '$time22')";
        ...
        $q68 = " UPDATE lectures_be SET subjects ='$subject22', prof_name = '$lecturer22' WHERE id = '$id22' ";
    ...
    if(isset($_POST['save24'])){
      ...
      $q69 = "SELECT * FROM lectures_be WHERE id = '$id23' ";
      $q69_exe = mysqli_query($db, $q69);
      $count23 = mysqli_num_rows($q69_exe);

      if($count23 == 0){
        $q70 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id23', '$subject23', '$lecturer23', '$day23', '$time23')";
        ...
        $q71 = " UPDATE lectures_be SET subjects ='$subject23', prof_name = '$lecturer23' WHERE id = '$id23' ";
    ...
    if(isset($_POST['save25'])){
      ...
      $q72 = "SELECT * FROM lectures_be WHERE id = '$id24' ";
      $q72_exe = mysqli_query($db, $q72);
      $count24 = mysqli_num_rows($q72_exe);

      if($count24 == 0){
        $q73 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id24', '$subject24', '$lecturer24', '$day24', '$time24')";
        ...
        $q74 = " UPDATE lectures_be SET subjects ='$subject24', prof_name = '$lecturer24' WHERE id = '$id24' ";
    ...
    if(isset($_POST['save26'])){
      ...
      $q75 = "SELECT * FROM lectures_be WHERE id = '$id25' ";
      $q75_exe = mysqli_query($db, $q75);
      $count25 = mysqli_num_rows($q75_exe);

      if($count25 == 0){
        $q76 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id25', '$subject25', '$lecturer25', '$day25', '$time25')";
        ...
        $q77 = " UPDATE lectures_be SET subjects ='$subject25', prof_name = '$lecturer25' WHERE id = '$id25' ";
    ...
    if(isset($_POST['save27'])){
      ...
      $q78 = "SELECT * FROM lectures_be WHERE id = '$id26' ";
      $q78_exe = mysqli_query($db, $q78);
      $count26 = mysqli_num_rows($q78_exe);

      if($count26 == 0){
        $q79 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id26', '$subject26', '$lecturer26', '$day26', '$time26')";
        ...
        $q80 = " UPDATE lectures_be SET subjects ='$subject26', prof_name = '$lecturer26' WHERE id = '$id26' ";
    ...
    if(isset($_POST['save28'])){
      ...
      $q81 = "SELECT * FROM lectures_be WHERE id = '$id27' ";
      $q81_exe = mysqli_query($db, $q81);
      $count27 = mysqli_num_rows($q81_exe);

      if($count27 == 0){
        $q82 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id27', '$subject27', '$lecturer27', '$day27', '$time27')";
        ...
        $q83 = " UPDATE lectures_be SET subjects ='$subject27', prof_name = '$lecturer27' WHERE id = '$id27' ";
    ...
    if(isset($_POST['save29'])){
      ...
      $q84 = "SELECT * FROM lectures_be WHERE id = '$id28' ";
      $q84_exe = mysqli_query($db, $q84);
      $count28 = mysqli_num_rows($q84_exe);

      if($count28 == 0){
        $q85 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id28', '$subject28', '$lecturer28', '$day28', '$time28')";
        ...
        $q86 = " UPDATE lectures_be SET subjects ='$subject28', prof_name = '$lecturer28' WHERE id = '$id28' ";
    ...
    if(isset($_POST['save30'])){
      ...
      $q87 = "SELECT * FROM lectures_be WHERE id = '$id29' ";
      $q87_exe = mysqli_query($db, $q87);
      $count29 = mysqli_num_rows($q87_exe);

      if($count29 == 0){
        $q88 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id29', '$subject29', '$lecturer29', '$day29', '$time29')";
        ...
        $q89 = " UPDATE lectures_be SET subjects ='$subject29', prof_name = '$lecturer29' WHERE id = '$id29' ";
    ...
    if(isset($_POST['save31'])){
      ...
      $q90 = "SELECT * FROM lectures_be WHERE id = '$id30' ";
      $q90_exe = mysqli_query($db, $q90);
      $count30 = mysqli_num_rows($q90_exe);

      if($count30 == 0){
        $q91 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id30', '$subject30', '$lecturer30', '$day30', '$time30')";
        ...
        $q92 = " UPDATE lectures_be SET subjects ='$subject30', prof_name = '$lecturer30' WHERE id = '$id30' ";
    ...
    if(isset($_POST['save32'])){
      ...
      $q93 = "SELECT * FROM lectures_be WHERE id = '$id31' ";
      $q93_exe = mysqli_query($db, $q93);
      $count31 = mysqli_num_rows($q93_exe);

      if($count31 == 0){
        $q94 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id31', '$subject31', '$lecturer31', '$day31', '$time31')";
        ...
        $q95 = " UPDATE lectures_be SET subjects ='$subject31', prof_name = '$lecturer31' WHERE id = '$id31' ";
    ...
    if(isset($_POST['save33'])){
      ...
      $q96 = "SELECT * FROM lectures_be WHERE id = '$id32' ";
      $q96_exe = mysqli_query($db, $q96);
      $count32 = mysqli_num_rows($q96_exe);

      if($count32 == 0){
        $q97 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id32', '$subject32', '$lecturer32', '$day32', '$time32')";
        ...
        $q98 = " UPDATE lectures_be SET subjects ='$subject32', prof_name = '$lecturer32' WHERE id = '$id32' ";
    ...
    if(isset($_POST['save34'])){
      ...
      $q99 = "SELECT * FROM lectures_be WHERE id = '$id33' ";
      $q99_exe = mysqli_query($db, $q99);
      $count33 = mysqli_num_rows($q99_exe);

      if($count33 == 0){
        $q100 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id33', '$subject33', '$lecturer33', '$day33', '$time33')";
        ...
        $q101 = " UPDATE lectures_be SET subjects ='$subject33', prof_name = '$lecturer33' WHERE id = '$id33' ";
    ...
    if(isset($_POST['save35'])){
      ...
      $q102 = "SELECT * FROM lectures_be WHERE id = '$id34' ";
      $q102_exe = mysqli_query($db, $q102);
      $count34 = mysqli_num_rows($q102_exe);

      if($count34 == 0){
        $q103 = "INSERT INTO lectures_be(id, subjects, prof_name, day, ltime) VALUES ('$id34', '$subject34', '$lecturer34', '$day34', '$time34')";
        ...
        $q104 = " UPDATE lectures_be SET subjects ='$subject34', prof_name = '$lecturer34' WHERE id = '$id34' ";
...
<body>
  <div class="container-fluid">
      ...
      <div class="sidebar">
        ...
        <form method="POST">
          ...
          <div class="col-lg-6 form-inline">
            ...
            <div class="custom-control custom-radio">
              <input type="radio" value="BE" id="typeRadio4" name="type" class="custom-control-input" checked onclick="document.location.href='timetable_be.php'">
           ...
           <a href="#be_tt">View in Simplified form??</a>
        <table id="loadetails" class="table table-bordered text-center">
         <tr class="card-header">
           <th colspan="10">Final Year Time Table</th>
         </tr>
         <tr class="card-header">
         ...
         <tr>
           ...
           <td>
            <?php 
              ...
              $disp_q = "SELECT * FROM lectures_be WHERE id = 1";
           ...
           <td>
            <?php 
              ...
              $disp_q1 = "SELECT * FROM lectures_be WHERE id = 2";
           ...
           <td>
            <?php 
              ...
              $disp_q2 = "SELECT * FROM lectures_be WHERE id = 3";
           ...
           <td>
            <?php 
              ...
              $disp_q3 = "SELECT * FROM lectures_be WHERE id = 4";
           ...
           <td>
            <?php 
              ...
              $disp_q4 = "SELECT * FROM lectures_be WHERE id = 5";
           ...
           <td>
            <?php 
              ...
              $disp_q5 = "SELECT * FROM lectures_be WHERE id = 6";
           ...
           <td>
            <?php 
              ...
              $disp_q6 = "SELECT * FROM lectures_be WHERE id = 7";
         ...
         <tr>
           ...
           <td>
            <?php 
              ...
              $disp_q7 = "SELECT * FROM lectures_be WHERE id = 8";
           ...
           <td>
            <?php 
              ...
              $disp_q8 = "SELECT * FROM lectures_be WHERE id = 9";
           ...
           <td>
            <?php 
              ...
              $disp_q9 = "SELECT * FROM lectures_be WHERE id = 10";
           ...
           <td>
            <?php 
              ...
              $disp_q10 = "SELECT * FROM lectures_be WHERE id = 11";
           ...
           <td>
            <?php 
              ...
              $disp_q11 = "SELECT * FROM lectures_be WHERE id = 12";
           ...
           <td>
            <?php 
              ...
              $disp_q12 = "SELECT * FROM lectures_be WHERE id = 13";
           ...
           <td>
            <?php 
              ...
              $disp_q13 = "SELECT * FROM lectures_be WHERE id = 14";
          ...
          <tr>
           ...
           <td>
            <?php 
              ...
              $disp_q14 = "SELECT * FROM lectures_be WHERE id = 15";
           ...
           <td>
            <?php 
              ...
              $disp_q15 = "SELECT * FROM lectures_be WHERE id = 16";
           ...
           <td>
            <?php 
              ...
              $disp_q16 = "SELECT * FROM lectures_be WHERE id = 17";
           ...
           <td>
            <?php 
              ...
              $disp_q17 = "SELECT * FROM lectures_be WHERE id = 18";
           ...
           <td>
            <?php 
              ...
              $disp_q18 = "SELECT * FROM lectures_be WHERE id = 19";
           ...
           <td>
            <?php 
              ...
              $disp_q19 = "SELECT * FROM lectures_be WHERE id = 20";
           ...
           <td>
            <?php 
              ...
              $disp_q20 = "SELECT * FROM lectures_be WHERE id = 21";
         ...
         <tr>
           ...
           <td>
            <?php 
              ...
              $disp_q21 = "SELECT * FROM lectures_be WHERE id = 22";
           ...
           <td>
            <?php 
              ...
              $disp_q22 = "SELECT * FROM lectures_be WHERE id = 23";
           ...
           <td>
            <?php 
              ...
              $disp_q23 = "SELECT * FROM lectures_be WHERE id = 24";
           ...
           <td>
            <?php 
              ...
              $disp_q24 = "SELECT * FROM lectures_be WHERE id = 25";
           ...
           <td>
            <?php 
              ...
              $disp_q25 = "SELECT * FROM lectures_be WHERE id = 26";
           ...
           <td>
            <?php 
              ...
              $disp_q26 = "SELECT * FROM lectures_be WHERE id = 27";
           ...
           <td>
            <?php 
              ...
              $disp_q27 = "SELECT * FROM lectures_be WHERE id = 28";
         ...
         <tr>
           ...
           <td>
            <?php 
              ...
              $disp_q28 = "SELECT * FROM lectures_be WHERE id = 29";
           ...
           <td>
            <?php 
              ...
              $disp_q29 = "SELECT * FROM lectures_be WHERE id = 30";
           ...
           <td>
            <?php 
              ...
              $disp_q30 = "SELECT * FROM lectures_be WHERE id = 31";
           ...
           <td>
            <?php 
              ...
              $disp_q31 = "SELECT * FROM lectures_be WHERE id = 32";
           ...
           <td>
            <?php 
              ...
              $disp_q32 = "SELECT * FROM lectures_be WHERE id = 33";
           ...
           <td>
            <?php 
              ...
              $disp_q33 = "SELECT * FROM lectures_be WHERE id = 34";
           ...
           <td>
            <?php 
              ...
              $disp_q34 = "SELECT * FROM lectures_be WHERE id = 35";
        ...
        <table class="table table-bordered text-center">
          ...
          <tr>
            <th>Monday</th>
          <?php 
            $query = "SELECT * FROM lectures_be WHERE day = 'Monday'";
          ...
          <tr>
            <th>Tuesday</th>
          <?php 
            $query = "SELECT * FROM lectures_be WHERE day = 'Tuesday'";
            $exe_query = mysqli_query($db, $query);
            while($res_exe_query = mysqli_fetch_array($exe_query)){
          ?>
            <td><p style="color: blue"><?php echo $res_exe_query['subjects']; ?></p>
          ...
          <tr>
            <th>Wednesday</th>
          <?php 
            $query = "SELECT * FROM lectures_be WHERE day = 'Wednesday'";
            $exe_query = mysqli_query($db, $query);
            while($res_exe_query = mysqli_fetch_array($exe_query)){
          ?>
            <td><p style="color: blue"><?php echo $res_exe_query['subjects']; ?></p>
          ...
          <tr>
            <th>Thursday</th>
          <?php 
            $query = "SELECT * FROM lectures_be WHERE day = 'Thursday'";
            $exe_query = mysqli_query($db, $query);
            while($res_exe_query = mysqli_fetch_array($exe_query)){
          ?>
            <td><p style="color: blue"><?php echo $res_exe_query['subjects']; ?></p>
          ...
          <tr>
            <th>Friday</th>
          <?php 
            $query = "SELECT * FROM lectures_be WHERE day = 'Friday'";
            $exe_query = mysqli_query($db, $query);
            while($res_exe_query = mysqli_fetch_array($exe_query)){
          ?>
            <td><p style="color: blue"><?php echo $res_exe_query['subjects']; ?></p>
          ...
          <button style="display: block; margin: auto" class="btn btn-info" onclick="print_tt('be_tt')">Print Time Table</button>          
      </div>
      ...
      <script type="text/javascript">
      function print_tt(be_tt){
        var backup = document.body.innerHTML;
          var get = document.getElementById("be_tt").innerHTML
